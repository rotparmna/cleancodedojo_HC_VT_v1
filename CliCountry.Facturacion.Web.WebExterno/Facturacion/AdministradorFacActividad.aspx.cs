...
namespace CliCountry.Facturacion.Web.WebExterno.Facturacion
{
    ...
    public partial class AdministradorFacActividad : WebPage
    {
        ...
        /// <summary>
        /// Método asincrono para consulta de contratos plan.
        /// </summary>
        ...
        public void ConsultarAtencion()
        {
            ...
            if (!string.IsNullOrEmpty(txtAtencion.Text.Trim()) && Page.IsValid)
            {
                if (CargarDatosCliente())
                {
                    this.CargarDetalleAtencion();     
                }
            }
            else
            {
        ...
        {
            var resultadoDepositos = WebService.Facturacion.ConsultarDepositos(new Atencion()
                {
            ...
            {
                this.DetalleCargarConceptosFactura(resultadoDepositos);
            }
            else
            {
        ...
        private void DetalleCargarConceptosFactura(Resultado<List<Deposito>> resultadoDepositos)
        {
        ...
        private bool CargarDatosCliente()
        {
            ...
            if (Atencion != null)
            {
                ...
                {
                    cargarInformacion = this.CargarDatosPantallaCliente(cargarInformacion);
                }
                else
                {
                    LimpiarDatosBasicos();
        ...
        private bool CargarDatosPantallaCliente(bool cargarInformacion)
        {
        ...
        private void CargarDetalleGeneracion(){}
